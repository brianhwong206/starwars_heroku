...
var path = require("path"); // npm install path , similar to fs package in reading files.
...
>>>>>>> 2b777690ca23815bbbe7b05bf8e29e574b623069
...
app.post("/api/characters", function(req, res) {
  ...
  res.json(newcharacter); // this will equal the data in add.html
});
